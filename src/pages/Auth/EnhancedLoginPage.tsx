// pages/Auth/EnhancedLoginPage.tsx
import { useState, useEffect } from 'react';
import { Link, useNavigate, useLocation } from 'react-router-dom';
import { useForm } from 'react-hook-form';
import { zodResolver } from '@hookform/resolvers/zod';
import { z } from 'zod';
import { LogIn, Loader2, Lock, Mail, Eye, EyeOff, AlertCircle } from 'lucide-react';
...
export const EnhancedLoginPage = () => {
    ...
    const handleDiscordLogin = async () => {
        try {
            const response = await authService.connectDiscord('login');
            if (response.url) {
            ...
            <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                    ...
                    <p style={{
                        ...
                        Sign in to access your Washington Gaming account
                    </p>
                </div>
